...
package local_project.test_share_file_server_0_1;
...
/**
 * Job: Test_Share_file_server Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Test_Share_file_server implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Test_Share_file_server";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_c0j9UJDjEem8_N5KEeA5_Q", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_c0j9UJDjEem8_N5KEeA5_Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Test_Share_file_server.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Test_Share_file_server.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_Test_Share_file_server = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_Test_Share_file_server = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_Test_Share_file_server.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_Test_Share_file_server.length == 0) {
   					commonByteArray_LOCAL_PROJECT_Test_Share_file_server = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_Test_Share_file_server = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_Test_Share_file_server, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_Test_Share_file_server, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_Test_Share_file_server) {
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row4.attributes)							
				);
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row4.attributeValues)							
				);
 ...
 */
    ...
    public static void main(String[] args){
        final Test_Share_file_server Test_Share_file_serverClass = new Test_Share_file_server();

        int exitCode = Test_Share_file_serverClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Test_Share_file_server.class.getClassLoader().getResourceAsStream("local_project/test_share_file_server_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Test_Share_file_server.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Test_Share_file_server");
        }
...
/************************************************************************************************
 *     175636 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/18 18:43:11 JST
 ************************************************************************************************/