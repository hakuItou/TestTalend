...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	try {        
		...
		jcifs.smb.SmbFile sf_tFileFetch_1 = new jcifs.smb.SmbFile(srcurl_tFileFetch_1, auth_tFileFetch_1);
			...
			java.io.File destFile_tFileFetch_1 = new java.io.File("./test_output_to_fileServer_0.1/", fileName_tFileFetch_1);
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = "./test_postgreSQL_0.1/Book1.xlsx";
 ...
 */
	...
	final String decryptedPassword_tSCPPut_1 = routines.system.PasswordEncryptUtil.decryptPassword("6450f62e41c7c4af");
        ...
        java.util.List<String> sourceList_tSCPPut_1 = new java.util.ArrayList<String>();
			if((new java.io.File("./test_output_to_fileServer_0.1/OutData.xls").exists()) 
			&& (new java.io.File("./test_output_to_fileServer_0.1/OutData.xls").isFile())){
				sourceList_tSCPPut_1.add("./test_output_to_fileServer_0.1/OutData.xls");
			}else{
        }   
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="./test_output_to_fileServer_0.1/OutData.xls";
	...
	try{
        if(sourceFileNames_tSCPPut_1!=null && sourceFileNames_tSCPPut_1.length!=0){
           	for (int i_tSCPPut_1 = 0; i_tSCPPut_1 < sourceFileNames_tSCPPut_1.length; i_tSCPPut_1++) {
				...
				try {
					out_tSCPPut_1 = scp_tSCPPut_1.put(remoteName_tSCPPut_1, sendSize_tSCPPut_1, "Share", "0644");
...
/************************************************************************************************
 *     186453 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/19 16:18:52 JST
 ************************************************************************************************/