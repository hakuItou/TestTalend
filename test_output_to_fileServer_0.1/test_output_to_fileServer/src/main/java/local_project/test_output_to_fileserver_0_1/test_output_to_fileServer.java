...
package local_project.test_output_to_fileserver_0_1;
...
/**
 * Job: test_output_to_fileServer Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class test_output_to_fileServer implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "test_output_to_fileServer";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_7r0jEJJcEemLVOj9JHNyMw", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_7r0jEJJcEemLVOj9JHNyMw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				test_output_to_fileServer.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(test_output_to_fileServer.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tSCPPut_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	String username_tFileFetch_1 = "";
	        
	
	
	 
	final String decryptedPassword_tFileFetch_1 = routines.system.PasswordEncryptUtil.decryptPassword("f4f7aba1746784ea");
	...
	try {        
		...
		jcifs.smb.SmbFile sf_tFileFetch_1 = new jcifs.smb.SmbFile(srcurl_tFileFetch_1, auth_tFileFetch_1);
			...
			java.io.File destFile_tFileFetch_1 = new java.io.File("/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/", fileName_tFileFetch_1);
...
public static class denormalize_4Struct implements routines.system.IPersistableRow<denormalize_4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_test_output_to_fileServer = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_test_output_to_fileServer = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(denormalize_4Struct other) {
...
denormalize_4Struct denormalize_4 = new denormalize_4Struct();
	...
	currentComponent="tDenormalize_1_DenormalizeOut";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("denormalize_4" + iterateId, 0, 0);
...
DenormalizeStructtDenormalize_1_DenormalizeOut denormalize_result_tDenormalize_1_DenormalizeOut = null;java.util.Map<String,java.util.Map<String,java.util.Map<String,
java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>>> hash_B_tDenormalize_1_DenormalizeOut = new java.util.HashMap<String,java.util.Map<String,java.util.Map<String,java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>>>();java.util.Map<String,java.util.Map<String,
java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>> hash_C_tDenormalize_1_DenormalizeOut = null;java.util.Map<String,
java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>> hash_D_tDenormalize_1_DenormalizeOut = null;
java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut> hash_E_tDenormalize_1_DenormalizeOut = null;
...
denormalize_4Struct denormalize_4_tmp = new denormalize_4Struct();
// ###############################
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = "/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/Book1.xlsx";
...
Var.B = row1.B == null ? Var.B:row1.B ;
Var.C = row1.C == null ? Var.C : row1.C ;
Var.D = row1.D == null ? Var.D : row1.D ;
Var.E =  row1.E == null ? Var.E : row1.E ;
Var.F = row1.F == null ? (Var.F == null ? " " :Var.F) : row1.F ;
Var.G = row1.G ;
Var.I = row1.I ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'denormalize_4'
denormalize_4_tmp.B = Var.B  ;
denormalize_4_tmp.C = Var.C  ;
denormalize_4_tmp.D = Var.D  ;
denormalize_4_tmp.E = Var.E  ;
denormalize_4_tmp.F = Var.F;
denormalize_4_tmp.G = Var.G  ;
denormalize_4_tmp.I = Var.I ;
denormalize_4 = denormalize_4_tmp;
// ###############################
 ...
 */
// Start of branch "denormalize_4"
if(denormalize_4 != null) { 
	...
	currentComponent="tDenormalize_1_DenormalizeOut";
			...
			//denormalize_4
				...
				if(execStat){
					runStat.updateStatOnConnection("denormalize_4"+iterateId,1, 1);
				} 
			

		

if(hash_B_tDenormalize_1_DenormalizeOut.containsKey(denormalize_4.B)){
	hash_C_tDenormalize_1_DenormalizeOut = hash_B_tDenormalize_1_DenormalizeOut.get(denormalize_4.B);                    
}else{
	hash_C_tDenormalize_1_DenormalizeOut = new java.util.HashMap<String,java.util.Map<String,java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>>();
	hash_B_tDenormalize_1_DenormalizeOut.put(denormalize_4.B,hash_C_tDenormalize_1_DenormalizeOut);
}
if(hash_C_tDenormalize_1_DenormalizeOut.containsKey(denormalize_4.C)){
	hash_D_tDenormalize_1_DenormalizeOut = hash_C_tDenormalize_1_DenormalizeOut.get(denormalize_4.C);                    
}else{
	hash_D_tDenormalize_1_DenormalizeOut = new java.util.HashMap<String,java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>();
	hash_C_tDenormalize_1_DenormalizeOut.put(denormalize_4.C,hash_D_tDenormalize_1_DenormalizeOut);
}
if(hash_D_tDenormalize_1_DenormalizeOut.containsKey(denormalize_4.D)){
	hash_E_tDenormalize_1_DenormalizeOut = hash_D_tDenormalize_1_DenormalizeOut.get(denormalize_4.D);                    
}else{
	hash_E_tDenormalize_1_DenormalizeOut = new java.util.HashMap<String, DenormalizeStructtDenormalize_1_DenormalizeOut>();
	hash_D_tDenormalize_1_DenormalizeOut.put(denormalize_4.D,hash_E_tDenormalize_1_DenormalizeOut);
}
if(hash_E_tDenormalize_1_DenormalizeOut.containsKey(denormalize_4.E)){
	denormalize_result_tDenormalize_1_DenormalizeOut = hash_E_tDenormalize_1_DenormalizeOut.get(denormalize_4.E);		
	denormalize_result_tDenormalize_1_DenormalizeOut.F.append(";").append(denormalize_4.F);
					
	denormalize_result_tDenormalize_1_DenormalizeOut.G.append(";").append(denormalize_4.G);
					
	denormalize_result_tDenormalize_1_DenormalizeOut.I.append(";").append(denormalize_4.I);
			                  
}else{
	denormalize_result_tDenormalize_1_DenormalizeOut = new DenormalizeStructtDenormalize_1_DenormalizeOut();		
	denormalize_result_tDenormalize_1_DenormalizeOut.F.append(denormalize_4.F);
					
	denormalize_result_tDenormalize_1_DenormalizeOut.G.append(denormalize_4.G);
					
	denormalize_result_tDenormalize_1_DenormalizeOut.I.append(denormalize_4.I);
			
	hash_E_tDenormalize_1_DenormalizeOut.put(denormalize_4.E, denormalize_result_tDenormalize_1_DenormalizeOut);
}
...
java.util.Iterator<String> B_iterator_tDenormalize_1_DenormalizeOut = hash_B_tDenormalize_1_DenormalizeOut.keySet().iterator();

while(B_iterator_tDenormalize_1_DenormalizeOut.hasNext()){

	String key_B_tDenormalize_1_DenormalizeOut = B_iterator_tDenormalize_1_DenormalizeOut.next();
	
	hash_C_tDenormalize_1_DenormalizeOut = hash_B_tDenormalize_1_DenormalizeOut.get(key_B_tDenormalize_1_DenormalizeOut);

java.util.Iterator<String> C_iterator_tDenormalize_1_DenormalizeOut = hash_C_tDenormalize_1_DenormalizeOut.keySet().iterator();

while(C_iterator_tDenormalize_1_DenormalizeOut.hasNext()){

	String key_C_tDenormalize_1_DenormalizeOut = C_iterator_tDenormalize_1_DenormalizeOut.next();
	
	hash_D_tDenormalize_1_DenormalizeOut = hash_C_tDenormalize_1_DenormalizeOut.get(key_C_tDenormalize_1_DenormalizeOut);

java.util.Iterator<String> D_iterator_tDenormalize_1_DenormalizeOut = hash_D_tDenormalize_1_DenormalizeOut.keySet().iterator();

while(D_iterator_tDenormalize_1_DenormalizeOut.hasNext()){

	String key_D_tDenormalize_1_DenormalizeOut = D_iterator_tDenormalize_1_DenormalizeOut.next();
	
	hash_E_tDenormalize_1_DenormalizeOut = hash_D_tDenormalize_1_DenormalizeOut.get(key_D_tDenormalize_1_DenormalizeOut);

java.util.Iterator<String> E_iterator_tDenormalize_1_DenormalizeOut = hash_E_tDenormalize_1_DenormalizeOut.keySet().iterator();

while(E_iterator_tDenormalize_1_DenormalizeOut.hasNext()){

	String key_E_tDenormalize_1_DenormalizeOut = E_iterator_tDenormalize_1_DenormalizeOut.next();
	
	denormalize_result_tDenormalize_1_DenormalizeOut = hash_E_tDenormalize_1_DenormalizeOut.get(key_E_tDenormalize_1_DenormalizeOut);

	OnRowsEndStructtDenormalize_1 denormalize_row_tDenormalize_1_DenormalizeOut = new OnRowsEndStructtDenormalize_1();
                
	denormalize_row_tDenormalize_1_DenormalizeOut.B = key_B_tDenormalize_1_DenormalizeOut;
	denormalize_row_tDenormalize_1_DenormalizeOut.C = key_C_tDenormalize_1_DenormalizeOut;
	denormalize_row_tDenormalize_1_DenormalizeOut.D = key_D_tDenormalize_1_DenormalizeOut;
	denormalize_row_tDenormalize_1_DenormalizeOut.E = key_E_tDenormalize_1_DenormalizeOut;
	denormalize_row_tDenormalize_1_DenormalizeOut.F = denormalize_result_tDenormalize_1_DenormalizeOut.F.toString();
	
	denormalize_row_tDenormalize_1_DenormalizeOut.G = denormalize_result_tDenormalize_1_DenormalizeOut.G.toString();
	
	denormalize_row_tDenormalize_1_DenormalizeOut.I = denormalize_result_tDenormalize_1_DenormalizeOut.I.toString();
...
globalMap.put("tDenormalize_1_DenormalizeOut_NB_LINE", result_list_tDenormalize_1_DenormalizeOut.size()); 
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("denormalize_4"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	final String decryptedPassword_tSCPPut_1 = routines.system.PasswordEncryptUtil.decryptPassword("6450f62e41c7c4af");
        ...
        java.util.List<String> sourceList_tSCPPut_1 = new java.util.ArrayList<String>();
			if((new java.io.File("/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/OutDataTest.xls").exists()) 
			&& (new java.io.File("/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/OutDataTest.xls").isFile())){
				sourceList_tSCPPut_1.add("/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/OutDataTest.xls");
			}else{
        }   
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="/var/lib/jenkins/workspace/TestUploadFile/test_output_to_fileServer_0.1/OutDataTest.xls";
		...
		xlsxTool_tFileOutputExcel_1.addCellValue("B");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("C");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("D");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("E");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("project");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("tracker");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("attributes");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("attributeValues");
 ...
 */
	...
	currentComponent="tDenormalize_1_ArrayIn";
        ...
        for(OnRowsEndStructtDenormalize_1 row_tDenormalize_1_ArrayIn : list_tDenormalize_1_ArrayIn){
    						...
    						row2.B = row_tDenormalize_1_ArrayIn.B;
    											
    						row2.C = row_tDenormalize_1_ArrayIn.C;
    											
    						row2.D = row_tDenormalize_1_ArrayIn.D;
    											
    						row2.E = row_tDenormalize_1_ArrayIn.E;
    											
    						row2.F = row_tDenormalize_1_ArrayIn.F;
    											
    						row2.G = row_tDenormalize_1_ArrayIn.G;
    											
    						row2.I = row_tDenormalize_1_ArrayIn.I;
...
String[] fArray = row2.F.split(";");
String[] gArray = row2.G.split(";");
String[] iArray = row2.I.split(";");

ArrayList<String> attributeList = new ArrayList<String>();
ArrayList<String> attributeValueList = new ArrayList<String>();
int index = 0;
for(String fStr : fArray){
  if(fStr.equals("個別設定項目")){
    if(gArray[index] != null && gArray[index].equals("プロジェクト")){
      row3.project = iArray[index];
    }else if(gArray[index] != null && gArray[index].equals("トラッカー種別")){
      row3.tracker = iArray[index];
    }
  }else if(fStr.equals("属性")){
  	attributeList.add(gArray[index]);
  	attributeValueList.add(iArray[index]);
  }
  
  index++;
}
row3.attributes = attributeList.toString();
row3.attributeValues = attributeValueList.toString();
...
String[] row_tBufferOutput_1=new String[]{"","","","","","","","",};		
	    ...
	    if(row3.project != null){
	            ...
	            row_tBufferOutput_1[4] = row3.project;
	                        			    
	    }else{
	    	row_tBufferOutput_1[4] = null;
	    }
	    if(row3.tracker != null){
	        
	            row_tBufferOutput_1[5] = row3.tracker;
	                        			    
	    }else{
	    	row_tBufferOutput_1[5] = null;
	    }
	    if(row3.attributes != null){
	        
	            row_tBufferOutput_1[6] = row3.attributes;
	                        			    
	    }else{
	    	row_tBufferOutput_1[6] = null;
	    }
	    if(row3.attributeValues != null){
	        
	            row_tBufferOutput_1[7] = row3.attributeValues;
			...
			//row4
				...
				xlsxTool_tFileOutputExcel_1.addRow();
	    				...
	    				if(row4.B != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.B));
	    				} else {
	    				...
	    				if(row4.C != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.C));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row4.D != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.D));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row4.E != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.E));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row4.project != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.project));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row4.tracker != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.tracker));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row4.attributes != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.attributes));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row4.attributeValues != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row4.attributeValues));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
...
String fileName_talendStats_FILE = "";
    fileName_talendStats_FILE = (new java.io.File("C:/TOS_DI-20181026_1147-V7.1.1/workspace/.metadata"+ "/" +"stats_file.txt")).getAbsolutePath().replace("\\","/");
...
String fileName_talendLogs_FILE = "";
    fileName_talendLogs_FILE = (new java.io.File("C:/TOS_DI-20181026_1147-V7.1.1/workspace/.metadata"+ "/" +"logs_file.txt")).getAbsolutePath().replace("\\","/");
...
String fileName_talendMeter_FILE = "";
    fileName_talendMeter_FILE = (new java.io.File("C:/TOS_DI-20181026_1147-V7.1.1/workspace/.metadata"+ "/" +"meter_file.txt")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public static void main(String[] args){
        final test_output_to_fileServer test_output_to_fileServerClass = new test_output_to_fileServer();

        int exitCode = test_output_to_fileServerClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test_output_to_fileServer.class.getClassLoader().getResourceAsStream("local_project/test_output_to_fileserver_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = test_output_to_fileServer.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test_output_to_fileServer");
        }
...
/************************************************************************************************
 *     186725 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/19 17:21:57 JST
 ************************************************************************************************/