...
package local_project.create_test_job_to_git_0_1;
...
/**
 * Job: create_test_job_to_git Purpose: create_test_job_to_git<br>
 * Description: create_test_job_to_git <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class create_test_job_to_git implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "create_test_job_to_git";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_OYyHsJDMEem8_N5KEeA5_Q", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_OYyHsJDMEem8_N5KEeA5_Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				create_test_job_to_git.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(create_test_job_to_git.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    ...
    static byte[] commonByteArray_LOCAL_PROJECT_create_test_job_to_git = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_create_test_job_to_git.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_create_test_job_to_git.length == 0) {
   					commonByteArray_LOCAL_PROJECT_create_test_job_to_git = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_create_test_job_to_git = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_create_test_job_to_git, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_create_test_job_to_git, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_create_test_job_to_git) {
 ...
 */
    ...
    public static void main(String[] args){
        final create_test_job_to_git create_test_job_to_gitClass = new create_test_job_to_git();

        int exitCode = create_test_job_to_gitClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = create_test_job_to_git.class.getClassLoader().getResourceAsStream("local_project/create_test_job_to_git_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = create_test_job_to_git.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : create_test_job_to_git");
        }
...
/************************************************************************************************
 *     170285 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/17 15:51:31 JST
 ************************************************************************************************/