...
package local_project.test_postgresql_0_1;
...
/**
 * Job: test_postgreSQL Purpose: test_postgreSQL<br>
 * Description: test_postgreSQL <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class test_postgreSQL implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "test_postgreSQL";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_YvfUIJI9EemLVOj9JHNyMw", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_YvfUIJI9EemLVOj9JHNyMw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				test_postgreSQL.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(test_postgreSQL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	try {        
		...
		jcifs.smb.SmbFile sf_tFileFetch_1 = new jcifs.smb.SmbFile(srcurl_tFileFetch_1, auth_tFileFetch_1);
			...
			java.io.File destFile_tFileFetch_1 = new java.io.File("./test_postgreSQL_0.1/", fileName_tFileFetch_1);
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_test_postgreSQL = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_test_postgreSQL = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_test_postgreSQL.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_test_postgreSQL.length == 0) {
   					commonByteArray_LOCAL_PROJECT_test_postgreSQL = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_test_postgreSQL = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_test_postgreSQL, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_test_postgreSQL, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_test_postgreSQL) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = "project_info";
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "project_info";
}
...
String dbUser_tDBOutput_1 = null;
    ...
    String url_tDBOutput_1 = "jdbc:postgresql://"+"172.16.0.200"+":"+"5432"+"/"+"TestDnSoft";
    dbUser_tDBOutput_1 = "postgres";
 
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("610243e4ca33e325f4f7aba1746784ea");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"project_nm\",\"pharse\",\"data_type\",\"connet_sys\",\"project\",\"tracker\",\"attributes\",\"attribute_values\") VALUES (?,?,?,?,?,?,?,?)";
...
} else {pstmt_tDBOutput_1.setString(1, row4.B);
}

                    if(row4.C == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row4.C);
}

                    if(row4.D == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row4.D);
}

                    if(row4.E == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row4.E);
}

                    if(row4.project == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row4.project);
}

                    if(row4.tracker == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row4.tracker);
}

                    if(row4.attributes == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, row4.attributes);
}

                    if(row4.attributeValues == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, row4.attributeValues);
}
 ...
 */
    ...
    public static void main(String[] args){
        final test_postgreSQL test_postgreSQLClass = new test_postgreSQL();

        int exitCode = test_postgreSQLClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test_postgreSQL.class.getClassLoader().getResourceAsStream("local_project/test_postgresql_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = test_postgreSQL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test_postgreSQL");
        }
...
/************************************************************************************************
 *     181901 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/19 14:34:45 JST
 ************************************************************************************************/