...
package local_project.pull_git_test_job_0_1;
...
/**
 * Job: pull_git_test_job Purpose: pull_git_test_job<br>
 * Description: pull_git_test_job <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class pull_git_test_job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "pull_git_test_job";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_NuZiYJDWEem8_N5KEeA5_Q", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_NuZiYJDWEem8_N5KEeA5_Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				pull_git_test_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(pull_git_test_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_pull_git_test_job = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_pull_git_test_job = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_pull_git_test_job) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_project.pre_get_git_inputfile_0_1.pre_get_git_inputFile childJob_tRunJob_1 = new local_project.pre_get_git_inputfile_0_1.pre_get_git_inputFile();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		local_project.create_test_job_to_git_0_1.create_test_job_to_git childJob_tRunJob_2 = new local_project.create_test_job_to_git_0_1.create_test_job_to_git();
	    // pass DataSources
...
public static class row_talendStats_STATSStruct implements routines.system.IPersistableRow<row_talendStats_STATSStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_pull_git_test_job.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_pull_git_test_job.length == 0) {
   					commonByteArray_LOCAL_PROJECT_pull_git_test_job = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_pull_git_test_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_pull_git_test_job, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_pull_git_test_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public static void main(String[] args){
        final pull_git_test_job pull_git_test_jobClass = new pull_git_test_job();

        int exitCode = pull_git_test_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = pull_git_test_job.class.getClassLoader().getResourceAsStream("local_project/pull_git_test_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = pull_git_test_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : pull_git_test_job");
        }
...
/************************************************************************************************
 *     107121 characters generated by Talend Open Studio for Data Integration 
 *     on the 2019/06/17 17:15:02 JST
 ************************************************************************************************/